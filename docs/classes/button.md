...
A {@link FlexContainer} which can be [clicked](clickable.md) as a button.
Since the button grabs all events, no events are propagated to the child.

## Hierarchy

- [`Clickable`](clickable.md)<`this`\> & `FlexContainer`<`this`\>
...
- [\_lastLayoutCtx](button.md#_lastlayoutctx)
...
- [lastVertical](button.md#lastvertical)
...
- [crossBasis](button.md#crossbasis)
- [dimensions](button.md#dimensions)
- [dirty](button.md#dirty)
- [enabled](button.md#enabled)
- [flexRatio](button.md#flexratio)
- [inheritedTheme](button.md#inheritedtheme)
- [internalCrossBasis](button.md#internalcrossbasis)
- [internalMainBasis](button.md#internalmainbasis)
- [layoutDirty](button.md#layoutdirty)
- [mainBasis](button.md#mainbasis)
- [theme](button.md#theme)
- [themeOverride](button.md#themeoverride)
- [vertical](button.md#vertical)
...
• **new Button**(`child`, `callback?`, `flexRatio?`, `mainBasis?`, `crossBasis?`, `vertical?`, `themeOverride?`)
...
Mixin(Clickable, FlexContainer).constructor
...
Mixin(Clickable, FlexContainer).\_children
...
Mixin(Clickable, FlexContainer).\_dirty
...
Mixin(Clickable, FlexContainer).\_lastLayoutCtx
...
Mixin(Clickable, FlexContainer).\_layoutDirty
...
Mixin(Clickable, FlexContainer).clickState
...
Mixin(Clickable, FlexContainer).clickStateChanged
...
Mixin(Clickable, FlexContainer).lastClickState
...
Mixin(Clickable, FlexContainer).lastVertical
...
Mixin(Clickable, FlexContainer).needsClear
...
Mixin(Clickable, FlexContainer).pointerPos
...
Mixin(Clickable, FlexContainer).propagatesEvents
...
Mixin(Clickable, FlexContainer).resolvedHeight
...
Mixin(Clickable, FlexContainer).resolvedWidth
...
Mixin(Clickable, FlexContainer).startingPointerPos
...
Mixin(Clickable, FlexContainer).wasClick
...
Mixin(Clickable, FlexContainer).clear
...
Mixin(Clickable, FlexContainer).dispatchEvent
...
Mixin(Clickable, FlexContainer).forceLayoutDirty
...
Mixin(Clickable, FlexContainer).getNormalInRect
...
Mixin(Clickable, FlexContainer).handleClickEvent
...
Mixin(Clickable, FlexContainer).handleEvent
...
Mixin(Clickable, FlexContainer).handlePainting
...
Mixin(Clickable, FlexContainer).handlePopulateLayout
...
Mixin(Clickable, FlexContainer).handlePostLayoutUpdate
...
Mixin(Clickable, FlexContainer).handlePreLayoutUpdate
...
Mixin(Clickable, FlexContainer).handleResolveLayout
...
Mixin(Clickable, FlexContainer).inheritTheme
...
Mixin(Clickable, FlexContainer).isNormalInRect
...
Mixin(Clickable, FlexContainer).isPointInRect
...
Mixin(Clickable, FlexContainer).onFocusDropped
...
Mixin(Clickable, FlexContainer).paint
...
Mixin(Clickable, FlexContainer).populateLayout
...
Mixin(Clickable, FlexContainer).postLayoutUpdate
...
Mixin(Clickable, FlexContainer).preLayoutUpdate
...
Mixin(Clickable, FlexContainer).resolveLayout
...
Mixin(Clickable, FlexContainer).setThemeOverride
...
Mixin(Clickable, FlexContainer).updateInheritedTheme
