...
- [\_lastLayoutCtx](basickey.md#_lastlayoutctx)
...
- [lastVertical](basickey.md#lastvertical)
...
• **new BasicKey**(`text`, `keyCode`, `keyContext`, `flexRatio?`, `mainBasis?`, `crossBasis?`, `themeOverride?`)
...
[widgets/VirtualKeyboard/BasicKey.ts:11](https://github.com/playkostudios/canvas-ui/blob/d57dd85/src/widgets/VirtualKeyboard/BasicKey.ts#L11)
