...
- [\_backgroundDirty](spacekey.md#_backgrounddirty)
...
• **new SpaceKey**(`keyContext`, `themeOverride?`)
...
[widgets/VirtualKeyboard/SpaceKey.ts:10](https://github.com/playkostudios/canvas-ui/blob/68aef90/src/widgets/VirtualKeyboard/SpaceKey.ts#L10)
