[canvas-ui](../README.md) / SpaceKey

# Class: SpaceKey

A [BasicKey](basickey.md) which emits ' ' key presses.
...
- [constructor](spacekey.md#constructor)

### Properties

- [\_children](spacekey.md#_children)
- [\_dirty](spacekey.md#_dirty)
- [\_lastLayoutCtx](spacekey.md#_lastlayoutctx)
- [\_layoutDirty](spacekey.md#_layoutdirty)
- [callback](spacekey.md#callback)
- [clickState](spacekey.md#clickstate)
- [clickStateChanged](spacekey.md#clickstatechanged)
- [lastClickState](spacekey.md#lastclickstate)
- [lastVertical](spacekey.md#lastvertical)
- [needsClear](spacekey.md#needsclear)
- [pointerPos](spacekey.md#pointerpos)
- [propagatesEvents](spacekey.md#propagatesevents)
- [resolvedHeight](spacekey.md#resolvedheight)
- [resolvedWidth](spacekey.md#resolvedwidth)
- [startingPointerPos](spacekey.md#startingpointerpos)
- [wasClick](spacekey.md#wasclick)

### Accessors

- [child](spacekey.md#child)
- [childCount](spacekey.md#childcount)
- [children](spacekey.md#children)
- [crossBasis](spacekey.md#crossbasis)
- [dimensions](spacekey.md#dimensions)
- [dirty](spacekey.md#dirty)
- [enabled](spacekey.md#enabled)
- [flexRatio](spacekey.md#flexratio)
- [forced](spacekey.md#forced)
- [inheritedTheme](spacekey.md#inheritedtheme)
- [internalCrossBasis](spacekey.md#internalcrossbasis)
- [internalMainBasis](spacekey.md#internalmainbasis)
- [layoutDirty](spacekey.md#layoutdirty)
- [mainBasis](spacekey.md#mainbasis)
- [theme](spacekey.md#theme)
- [themeOverride](spacekey.md#themeoverride)
- [vertical](spacekey.md#vertical)

### Methods

- [clear](spacekey.md#clear)
- [dispatchEvent](spacekey.md#dispatchevent)
- [forceLayoutDirty](spacekey.md#forcelayoutdirty)
- [getNormalInRect](spacekey.md#getnormalinrect)
- [handleClickEvent](spacekey.md#handleclickevent)
- [handleEvent](spacekey.md#handleevent)
- [handlePainting](spacekey.md#handlepainting)
- [handlePopulateLayout](spacekey.md#handlepopulatelayout)
- [handlePostLayoutUpdate](spacekey.md#handlepostlayoutupdate)
- [handlePreLayoutUpdate](spacekey.md#handleprelayoutupdate)
- [handleResolveLayout](spacekey.md#handleresolvelayout)
- [inheritTheme](spacekey.md#inherittheme)
- [isNormalInRect](spacekey.md#isnormalinrect)
- [isPointInRect](spacekey.md#ispointinrect)
- [onFocusDropped](spacekey.md#onfocusdropped)
- [paint](spacekey.md#paint)
- [populateLayout](spacekey.md#populatelayout)
- [postLayoutUpdate](spacekey.md#postlayoutupdate)
- [preLayoutUpdate](spacekey.md#prelayoutupdate)
- [resolveLayout](spacekey.md#resolvelayout)
- [setThemeOverride](spacekey.md#setthemeoverride)
- [updateInheritedTheme](spacekey.md#updateinheritedtheme)

## Constructors

### constructor

• **new SpaceKey**(`keyContext`, `flexRatio?`, `mainBasis?`, `crossBasis?`, `themeOverride?`)
...
[widgets/VirtualKeyboard/SpaceKey.ts:10](https://github.com/playkostudios/canvas-ui/blob/d57dd85/src/widgets/VirtualKeyboard/SpaceKey.ts#L10)
...
See [children](spacekey.md#children) for the public iterator getter.
...
Like [pointerPos](spacekey.md#pointerpos), but only updated when a hold state begins.
...
[resolvedWidth](spacekey.md#resolvedwidth) and [resolvedHeight](spacekey.md#resolvedheight).
...
Check if the widget is dirty. Returns [_dirty](spacekey.md#_dirty).
...
If changed, [_enabled](domroot.md#_enabled) is set, [_layoutDirty](spacekey.md#_layoutdirty) is set to true
and [_dirty](spacekey.md#_dirty) is set to true if enabled or false if not enabled.
...
If setting, calls [inheritTheme](spacekey.md#inherittheme).
...
Check if the widget's layout is dirty. Returns [_layoutDirty](spacekey.md#_layoutdirty).
...
If setting, calls [setThemeOverride](spacekey.md#setthemeoverride).
...
else, the [handleEvent](spacekey.md#handleevent) method is called and its result is
...
Sets [_layoutDirty](spacekey.md#_layoutdirty) and [_dirty](spacekey.md#_dirty) to true.
...
Updates the current [clickState](spacekey.md#clickstate) given an event, as well as
[focus](domroot.md#_foci), [pointerStyle](domroot.md#pointerstyle), [wasClick](spacekey.md#wasclick) and
[clickStateChanged](spacekey.md#clickstatechanged) flags.
...
widget (sets [resolvedWidth](spacekey.md#resolvedwidth) and [resolvedHeight](spacekey.md#resolvedheight)).Must be
implemented. If called and not implemented, an exception is thrown.
...
Calls [updateInheritedTheme](spacekey.md#updateinheritedtheme) and [updateTheme](widget.md#updatetheme) and sets
[_layoutDirty](spacekey.md#_layoutdirty) and [_dirty](spacekey.md#_dirty) to true if widget is enabled.
...
[needsClear](spacekey.md#needsclear) is true, calls the [handlePainting](spacekey.md#handlepainting) method and
...
Wrapper for [handlePopulateLayout](spacekey.md#handlepopulatelayout). Does nothing if
...
[handlePostLayoutUpdate](spacekey.md#handlepostlayoutupdate) if widget is enabled. Must not be
overridden.
...
[handlePreLayoutUpdate](spacekey.md#handleprelayoutupdate) if widget is enabled. Must not be
overridden.
...
Wrapper for [handleResolveLayout](spacekey.md#handleresolvelayout). Does nothing if
[_enabled](domroot.md#_enabled) is false or [_layoutDirty](spacekey.md#_layoutdirty) is false. If the
resolved dimensions change, [_dirty](spacekey.md#_dirty) is set to true.
[_layoutDirty](spacekey.md#_layoutdirty) is set to false. Must not be overridden.
...
Calls [updateTheme](widget.md#updatetheme) and sets [_layoutDirty](spacekey.md#_layoutdirty) and
[_dirty](spacekey.md#_dirty) to true if widget is enabled.
