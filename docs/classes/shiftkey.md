...
- [\_backgroundDirty](shiftkey.md#_backgrounddirty)
...
• **new ShiftKey**(`keyContext`, `themeOverride?`)
...
[widgets/VirtualKeyboard/ShiftKey.ts:11](https://github.com/playkostudios/canvas-ui/blob/68aef90/src/widgets/VirtualKeyboard/ShiftKey.ts#L11)
