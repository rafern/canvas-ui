[canvas-ui](../README.md) / BackspaceKey
...
- [\_lastLayoutCtx](backspacekey.md#_lastlayoutctx)
...
- [lastVertical](backspacekey.md#lastvertical)
...
• **new BackspaceKey**(`keyContext`, `flexRatio?`, `mainBasis?`, `crossBasis?`, `themeOverride?`)
...
[widgets/VirtualKeyboard/BackspaceKey.ts:10](https://github.com/playkostudios/canvas-ui/blob/d57dd85/src/widgets/VirtualKeyboard/BackspaceKey.ts#L10)
