...
class Root {
    ...
    constructor(child, pointerStyleHandler = null, theme = defaultTheme /*debugTheme*/) {
        ...
        this._currentPointerStyle = 'default';
...
var index$8 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    DefaultTextInputHandler: DefaultTextInputHandler,
    get FocusType () { return FocusType; },
    Root: Root,
    Viewport: Viewport
});
...
function Labelable(Base) {
    return class Labelable extends Base {
        constructor() {
            ...
            this._minLabelAscent = 0;
            this._minLabelDescent = 0;
            // Text dimensions corrected for minimum dimensions
            this._labelWidth = 0;
            this._labelAscent = 0;
            this._labelDescent = 0;
...
var index$4 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    get ClickState () { return ClickState; },
    Clickable: Clickable,
    Labelable: Labelable,
    Parent: Parent,
    Variable: Variable
...
class Widget {
    ...
    // eslint-disable-next-line @typescript-eslint/no-empty-function
    handlePainting(_x, _y, _width, _height, _ctx) { }
...
var index$1 = /*#__PURE__*/Object.freeze({
    ...
    Theme: Theme,
    get ThemeProperty () { return ThemeProperty; }
});
...
var index = /*#__PURE__*/Object.freeze({
    ...
    MultiParentWidget: MultiParentWidget,
    ParentWidget: ParentWidget,
    PassthroughWidget: PassthroughWidget,
    ScrollableViewportWidget: ScrollableViewportWidget,
    ScrollBar: ScrollBar,
    SingleParentWidget: SingleParentWidget,
    Slider: Slider,
    Spacing: Spacing,
    TextInput: TextInput,
...
export { index$8 as core, index$7 as drivers, index$6 as events, index$5 as interfaces, index$4 as mixins, index$2 as templates, index$1 as theme, index as widgets };
