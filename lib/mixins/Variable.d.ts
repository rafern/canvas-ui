...
export declare class Variable<V> extends Widget {
    ...
    protected callback: VariableCallback<V> | null;
    /**
 ...
 * @category Mixin
 */
export declare class BooleanVariable extends Variable<boolean> {
}
/**
 ...
 * @category Mixin
 */
export declare class NumberVariable extends Variable<number> {
}
/**
 ...
 * @category Mixin
 */
export declare class StringVariable extends Variable<string> {
}
