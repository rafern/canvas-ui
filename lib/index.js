...
class FilledButton extends Button {
    constructor() {
        ...
        this.backgroundProperty = exports.ThemeProperty.BackgroundFill; // XXX private
    ...
    updateBackground() {
        var _a;
        if (this._forced)
            this.backgroundProperty = exports.ThemeProperty.PrimaryFill;
        else {
            switch (this.clickState) {
                case exports.ClickState.Hold:
                    this.backgroundProperty = exports.ThemeProperty.AccentFill;
                    break;
                case exports.ClickState.Hover:
                    this.backgroundProperty = exports.ThemeProperty.BackgroundGlowFill;
                    break;
                default:
                    this.backgroundProperty = exports.ThemeProperty.BackgroundFill;
                    break;
            }
        }
...
class ViewportWidget extends Parent(FlexWidget) {
    ...
    constructor(child, mainBasisTied = false, crossBasisTied = false, themeOverride = null) {
        ...
        this.lastChildLayoutCtx = null; // XXX private
...
class TextInput extends Labelable(Variable(FlexWidget)) {
    ...
    constructor(callback = null, initialValue = '', themeOverride = null) {
        ...
        // Is editing enabled?
        _editingEnabled.set(this, true); // XXX private
        // Is the text hidden?
        _hideText.set(this, false); // XXX private
        this.callback = callback;
        this._value = initialValue;
    ...
    handlePainting(x, y, width, height, ctx) {
        ...
        ctx.fillText(this.displayedText, x, y + height - this.labelDescent);
        // Paint blink
...
_editingEnabled = new WeakMap(), _hideText = new WeakMap();
