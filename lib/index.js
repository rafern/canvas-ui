...
})(exports.FocusType || (exports.FocusType = {}));
...
})(exports.ThemeProperty || (exports.ThemeProperty = {}));
...
const defaultTheme = new Theme(new Map([
    [exports.ThemeProperty.CanvasFill, 'rgba(0,0,0,0.5)'],
    [exports.ThemeProperty.ContainerPadding, {
            left: 4,
            right: 4,
            top: 4,
            bottom: 4,
        }],
    [exports.ThemeProperty.ContainerAlignment, {
            horizontal: exports.Alignment.Start, vertical: exports.Alignment.Start
        }],
    [exports.ThemeProperty.ContainerSpacing, 4],
    [exports.ThemeProperty.PrimaryFill, 'rgb(0,127,255)'],
    [exports.ThemeProperty.AccentFill, 'rgb(0,195,255)'],
    [exports.ThemeProperty.BackgroundFill, 'rgb(32,32,32)'],
    [exports.ThemeProperty.BackgroundGlowFill, 'rgb(48,48,48)'],
    [exports.ThemeProperty.SliderFlexRatio, 1],
    [exports.ThemeProperty.SliderMainBasis, 100],
    [exports.ThemeProperty.SliderCrossBasis, 10],
    [exports.ThemeProperty.BodyTextFont, '16px sans'],
    [exports.ThemeProperty.BodyTextFill, 'white'],
    [exports.ThemeProperty.LabelMinWidth, 0],
    [exports.ThemeProperty.LabelMinAscent, 0],
    [exports.ThemeProperty.LabelMinDescent, 3],
    [exports.ThemeProperty.CheckboxLength, 12],
    [exports.ThemeProperty.CheckboxInnerPadding, 2],
    [exports.ThemeProperty.InputBackgroundFill, 'white'],
    [exports.ThemeProperty.InputTextFont, '16px mono'],
    [exports.ThemeProperty.InputTextFill, 'black'],
    [exports.ThemeProperty.InputTextFillDisabled, 'grey'],
    [exports.ThemeProperty.InputTextFillInvalid, 'red'],
    [exports.ThemeProperty.InputTextFlexRatio, 1],
    [exports.ThemeProperty.InputTextMinWidth, 100],
    [exports.ThemeProperty.InputTextMinAscent, 16],
    [exports.ThemeProperty.InputTextMinDescent, 3],
    [exports.ThemeProperty.BlinkRate, 0.8],
    [exports.ThemeProperty.CursorPadding, 2],
    [exports.ThemeProperty.CursorThickness, 2],
    [exports.ThemeProperty.ScrollBarThickness, 10],
]));
...
class Leave extends Event {
    constructor(target = null) {
        super(target, exports.FocusType.Pointer, true);
    }
...
var _maxDimensions, _forceLayout;
...
class Viewport {
    constructor(startingWidth = 64, startingHeight = 64) {
        ...
        _maxDimensions.set(this, [0, 0]);
        // Does the viewport need to force-mark layout as dirty?
        _forceLayout.set(this, false);
    ...
    set maxDimensions(maxDimensions) {
        if (__classPrivateFieldGet(this, _maxDimensions)[0] !== maxDimensions[0] ||
            __classPrivateFieldGet(this, _maxDimensions)[1] !== maxDimensions[1]) {
            __classPrivateFieldGet(this, _maxDimensions)[0] = maxDimensions[0];
            __classPrivateFieldGet(this, _maxDimensions)[1] = maxDimensions[1];
            __classPrivateFieldSet(this, _forceLayout, true);
        }
    }
    get maxDimensions() {
        return [__classPrivateFieldGet(this, _maxDimensions)[0], __classPrivateFieldGet(this, _maxDimensions)[1]];
    }
    populateChildsLayout(child) {
        // Force layout resolution
        if (__classPrivateFieldGet(this, _forceLayout)) {
            __classPrivateFieldSet(this, _forceLayout, false);
        ...
        const layoutCtx = new LayoutContext(__classPrivateFieldGet(this, _maxDimensions)[0], __classPrivateFieldGet(this, _maxDimensions)[1], this.vertical);
...
_maxDimensions = new WeakMap(), _forceLayout = new WeakMap();
...
class Root {
    ...
    constructor(child, pointerStyleHandler = null, theme = defaultTheme /*debugTheme*/) {
        ...
        this.foci = new Map([
            [exports.FocusType.Keyboard, null],
            [exports.FocusType.Pointer, null],
        ]);
    ...
    dispatchEvent(event) {
        ...
        if (event.focusType !== null) {
            ...
            if (event.focusType === exports.FocusType.Pointer) {
...
class KeyEvent extends Event {
    constructor(key, target) {
        super(target, exports.FocusType.Keyboard, true);
        this.key = key;
    }
}
...
class PointerMove extends PointerEvent {
    constructor(x, y, target = null) {
        super(x, y, target, exports.FocusType.Pointer);
    }
...
function Clickable(Base) {
    return class Clickable extends Base {
        constructor() {
            ...
            this.lastClickState = exports.ClickState.Released; // XXX protected
            this.clickState = exports.ClickState.Released; // XXX protected
        ...
        setClickState(clickState, inside) {
            if (this.clickState !== clickState) {
                ...
                this.wasClick = inside && this.lastClickState === exports.ClickState.Hold;
        ...
        handleClickEvent(event, root, clickArea) {
            if (event instanceof Leave) {
                ...
                root.dropFocus(exports.FocusType.Pointer, this);
                this.pointerPos = null;
                return this.setClickState(exports.ClickState.Released, false);
            }
                ...
                if (event instanceof PointerPress) {
                    ...
                    root.requestFocus(exports.FocusType.Pointer, this);
                    return this.setClickState(exports.ClickState.Hold, inside);
                }
                // If this is a release event, drop focus
                if (event instanceof PointerRelease) {
                    root.dropFocus(exports.FocusType.Pointer, this);
                    if (inside)
                        return this.setClickState(exports.ClickState.Hover, inside);
                    else
                        return this.setClickState(exports.ClickState.Released, inside);
                }
...
function Labelable(Base) {
    var _labelWidth, _labelAscent, _labelDescent, _labelDirty, _a;
    return _a = class Labelable extends Base {
            constructor() {
                ...
                _labelWidth.set(this, 0);
                _labelAscent.set(this, 0);
                _labelDescent.set(this, 0);
                // Does the label need to be re-measured?
                _labelDirty.set(this, true);
            }
            updateTextDims() {
                // Abort if not dirty
                if (!__classPrivateFieldGet(this, _labelDirty))
                    return;
                // Measure text dimensions
                const [width, ascent, descent] = measureTextDims(this._text, this._font);
                __classPrivateFieldSet(this, _labelWidth, Math.max(width, this._minLabelWidth));
                __classPrivateFieldSet(this, _labelAscent, Math.max(ascent, this._minLabelAscent));
                __classPrivateFieldSet(this, _labelDescent, Math.max(descent, this._minLabelDescent));
                // Mark as clean
                __classPrivateFieldSet(this, _labelDirty, false);
            }
            ...
            setLabelDirty() {
                __classPrivateFieldSet(// XXX private
                this, _labelDirty, true);
                this.layoutDirty = true;
            }
            get labelWidth() {
                this.updateTextDims();
                return __classPrivateFieldGet(this, _labelWidth);
            }
            get labelAscent() {
                this.updateTextDims();
                return __classPrivateFieldGet(this, _labelAscent);
            }
            get labelDescent() {
                this.updateTextDims();
                return __classPrivateFieldGet(this, _labelDescent);
            }
            get labelHeight() {
                this.updateTextDims();
                return __classPrivateFieldGet(this, _labelAscent) + __classPrivateFieldGet(this, _labelDescent);
            }
            setText(text) {
                if (this._text !== text) {
                    this._text = text;
        ...
        _labelWidth = new WeakMap(),
        _labelAscent = new WeakMap(),
        _labelDescent = new WeakMap(),
        _labelDirty = new WeakMap(),
        _a;
}
...
var _enabled, _themeOverride, _theme, _inheritedTheme;
// FIXME protected and private members were turned public due to a declaration
// emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
...
class Widget {
    ...
    constructor(themeOverride, needsClear, propagatesEvents) {
        ...
        _themeOverride.set(this, void 0);
        // The current theme in use by the Widget
        _theme.set(this, null);
        // The inherited theme
        _inheritedTheme.set(this, null);
        ...
        __classPrivateFieldSet(this, _themeOverride, themeOverride);
    }
    // Called when the inherited theme of this Widget is updated. Can be
    ...
    // be overridden
    updateTheme() {
        if (__classPrivateFieldGet(this, _themeOverride) === null)
            __classPrivateFieldSet(this, _theme, __classPrivateFieldGet(this, _inheritedTheme));
        else {
            __classPrivateFieldGet(this, _themeOverride).fallback = __classPrivateFieldGet(this, _inheritedTheme);
            __classPrivateFieldSet(this, _theme, __classPrivateFieldGet(this, _themeOverride));
        }
    }
    // The current theme in use by the Widget. If there is no theme, throws an
    // exception
    get theme() {
        if (__classPrivateFieldGet(this, _theme) === null)
            throw 'Widget theme is not ready';
        return __classPrivateFieldGet(this, _theme);
    }
    ...
    // Enable this widget
    enable() {
        if (!__classPrivateFieldGet(this, _enabled)) {
            __classPrivateFieldSet(this, _enabled, true);
            this.layoutDirty = true;
            this.dirty = true;
        }
    }
    ...
    disable() {
        if (__classPrivateFieldGet(this, _enabled)) {
            __classPrivateFieldSet(this, _enabled, false);
            this.layoutDirty = true;
            this.dirty = false;
        }
    }
    ...
    setThemeOverride(theme) {
        ...
        if (__classPrivateFieldGet(this, _themeOverride) === theme)
            return;
        __classPrivateFieldSet(this, _themeOverride, theme);
        this.updateTheme();
        if (__classPrivateFieldGet(this, _enabled)) {
            this.layoutDirty = true;
            this.dirty = true;
    ...
    getThemeOverride() {
        return __classPrivateFieldGet(this, _themeOverride);
    }
    // Set the inherited theme of this Widget. Should not be overridden, but can
    // be. If overridden, the original method should still be called.
    inheritTheme(theme) {
        // Abort if theme hasn't changed
        if (__classPrivateFieldGet(this, _inheritedTheme) === theme)
            return;
        __classPrivateFieldSet(this, _inheritedTheme, theme);
    ...
    getInheritedTheme() {
        return __classPrivateFieldGet(this, _inheritedTheme);
    }
    ...
    clear(x, y, width, height, ctx) {
        ...
        ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.CanvasFill);
        ctx.beginPath();
...
_enabled = new WeakMap(), _themeOverride = new WeakMap(), _theme = new WeakMap(), _inheritedTheme = new WeakMap();
...
class BaseContainer extends SingleParentWidget {
    ...
    handlePopulateLayout(layoutCtx) {
        ...
        const padding = this.theme.getPadding(exports.ThemeProperty.ContainerPadding);
    ...
    calcChildViewport(x, y, width, height) {
        ...
        // Horizontal axis
        const alignment = this.theme.getAlignment2D(exports.ThemeProperty.ContainerAlignment);
        if (alignment.horizontal !== exports.Alignment.Stretch) {
        ...
        // Vertical axis
        if (alignment.vertical !== exports.Alignment.Stretch) {
...
var _backgroundProperty, _forced;
// FIXME protected and private members were turned public due to a declaration
// emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
...
class FilledButton extends Button {
    constructor() {
        ...
        _backgroundProperty.set(this, exports.ThemeProperty.BackgroundFill);
        // Is the button currently forced down?
        _forced.set(this, false);
    }
    updateBackground() {
        var _a;
        if (__classPrivateFieldGet(this, _forced))
            __classPrivateFieldSet(this, _backgroundProperty, exports.ThemeProperty.PrimaryFill);
        else {
            switch (this.clickState) {
                case exports.ClickState.Hold:
                    __classPrivateFieldSet(this, _backgroundProperty, exports.ThemeProperty.AccentFill);
                    break;
                case exports.ClickState.Hover:
                    __classPrivateFieldSet(this, _backgroundProperty, exports.ThemeProperty.BackgroundGlowFill);
                    break;
                default:
                    __classPrivateFieldSet(this, _backgroundProperty, exports.ThemeProperty.BackgroundFill);
                    break;
            }
        }
        // Update inherited theme
        const overrideValue = this.theme.getFill(__classPrivateFieldGet(this, _backgroundProperty));
        const modifiedTheme = new Theme(new Map([
            [exports.ThemeProperty.CanvasFill, overrideValue],
        ]), (_a = this.getInheritedTheme()) === null || _a === void 0 ? void 0 : _a.fallback);
        super.inheritTheme(modifiedTheme);
        this.backgroundDirty = true;
    }
    set forced(forced) {
        if (forced !== __classPrivateFieldGet(this, _forced)) {
            __classPrivateFieldSet(this, _forced, forced);
            this.updateBackground();
        }
    }
    get forced() {
        return __classPrivateFieldGet(this, _forced);
    }
    setThemeOverride(theme) {
        this.backgroundDirty = true;
        if (theme === null)
        ...
        try {
            const overrideValue = theme.getFill(__classPrivateFieldGet(this, _backgroundProperty));
            const modifiedTheme = new Theme(new Map([
                [exports.ThemeProperty.CanvasFill, overrideValue],
            ]));
    ...
    inheritTheme(theme) {
        ...
        const canvasValue = theme.getFill(__classPrivateFieldGet(this, _backgroundProperty));
        const modifiedTheme = new Theme(new Map([
            [exports.ThemeProperty.CanvasFill, canvasValue],
        ]), theme);
        super.inheritTheme(modifiedTheme);
    }
    handlePostLayoutUpdate(root) {
...
_backgroundProperty = new WeakMap(), _forced = new WeakMap();

var _flexRatio, _mainBasis, _crossBasis, _internalMainBasis, _internalCrossBasis, _effectiveMainBasis, _effectiveCrossBasis, _vertical$1;
// FIXME protected and private members were turned public due to a declaration
// emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
...
class FlexWidget extends Widget {
    constructor() {
        ...
        _flexRatio.set(this, 1);
        // The minimum main-axis and cross-axis lengths
        _mainBasis.set(this, 0);
        _crossBasis.set(this, 0);
        // Like mainBasis and crossBasis, but meant to be updated per frame. The
        // biggest of the two sets will be used
        _internalMainBasis.set(this, 0);
        _internalCrossBasis.set(this, 0);
        // The last effective mainBasis and crossBasis, aka, the last used maximum
        // between the internal and normal set of basis
        _effectiveMainBasis.set(this, 0);
        _effectiveCrossBasis.set(this, 0);
        // Growth direction of flexbox. Is it vertical? If null, it will inherit the
        // verticality of the layout context
        _vertical$1.set(this, null);
        // Was the last layout vertical or not? Never null
        this.lastVertical = true;
    }
    get flexRatio() {
        return __classPrivateFieldGet(this, _flexRatio);
    }
    set flexRatio(flexRatio) {
        if (__classPrivateFieldGet(this, _flexRatio) !== flexRatio) {
            __classPrivateFieldSet(this, _flexRatio, flexRatio);
            this.layoutDirty = true;
        }
    }
    get vertical() {
        return __classPrivateFieldGet(this, _vertical$1);
    }
    set vertical(vertical) {
        if (__classPrivateFieldGet(this, _vertical$1) !== vertical) {
            __classPrivateFieldSet(this, _vertical$1, vertical);
            this.layoutDirty = true;
        }
    }
    get mainBasis() {
        return __classPrivateFieldGet(this, _mainBasis);
    }
    set mainBasis(mainBasis) {
        if (__classPrivateFieldGet(this, _mainBasis) !== mainBasis) {
            __classPrivateFieldSet(this, _mainBasis, mainBasis);
            this.updateEffectiveMainBasis();
        }
    }
    get crossBasis() {
        return __classPrivateFieldGet(this, _crossBasis);
    }
    set crossBasis(crossBasis) {
        if (__classPrivateFieldGet(this, _crossBasis) !== crossBasis) {
            __classPrivateFieldSet(this, _crossBasis, crossBasis);
            this.updateEffectiveCrossBasis();
        }
    }
    get internalMainBasis() {
        return __classPrivateFieldGet(this, _internalMainBasis);
    }
    set internalMainBasis(internalMainBasis) {
        if (__classPrivateFieldGet(this, _internalMainBasis) !== internalMainBasis) {
            __classPrivateFieldSet(this, _internalMainBasis, internalMainBasis);
            this.updateEffectiveMainBasis();
        }
    }
    get internalCrossBasis() {
        return __classPrivateFieldGet(this, _internalCrossBasis);
    }
    set internalCrossBasis(internalCrossBasis) {
        if (__classPrivateFieldGet(this, _internalCrossBasis) !== internalCrossBasis) {
            __classPrivateFieldSet(this, _internalCrossBasis, internalCrossBasis);
            this.updateEffectiveCrossBasis();
        }
    }
    updateEffectiveMainBasis() {
        const effectiveMainBasis = Math.max(__classPrivateFieldGet(this, _mainBasis), __classPrivateFieldGet(this, _internalMainBasis));
        if (__classPrivateFieldGet(this, _effectiveMainBasis) !== effectiveMainBasis) {
            __classPrivateFieldSet(this, _effectiveMainBasis, effectiveMainBasis);
            this.layoutDirty = true;
        }
    }
    updateEffectiveCrossBasis() {
        const effectiveCrossBasis = Math.max(__classPrivateFieldGet(this, _crossBasis), __classPrivateFieldGet(this, _internalCrossBasis));
        if (__classPrivateFieldGet(this, _effectiveCrossBasis) !== effectiveCrossBasis) {
            __classPrivateFieldSet(this, _effectiveCrossBasis, effectiveCrossBasis);
            this.layoutDirty = true;
        }
    }
    handlePopulateLayout(layoutCtx) {
        ...
        if (layoutCtx.vertical === vertical) {
            if (vertical) {
                if (__classPrivateFieldGet(this, _flexRatio) > 0)
                    layoutCtx.vFlex += __classPrivateFieldGet(this, _flexRatio);
                layoutCtx.vBasis += __classPrivateFieldGet(this, _effectiveMainBasis);
                if (__classPrivateFieldGet(this, _effectiveCrossBasis) > layoutCtx.hBasis)
                    layoutCtx.hBasis = __classPrivateFieldGet(this, _effectiveCrossBasis);
            }
            else {
                if (__classPrivateFieldGet(this, _flexRatio) > 0)
                    layoutCtx.hFlex += __classPrivateFieldGet(this, _flexRatio);
                layoutCtx.hBasis += __classPrivateFieldGet(this, _effectiveMainBasis);
                if (__classPrivateFieldGet(this, _effectiveCrossBasis) > layoutCtx.vBasis)
                    layoutCtx.vBasis = __classPrivateFieldGet(this, _effectiveCrossBasis);
            }
        }
        else {
            if (vertical) {
                layoutCtx.hBasis += __classPrivateFieldGet(this, _effectiveCrossBasis);
                if (__classPrivateFieldGet(this, _effectiveMainBasis) > layoutCtx.vBasis)
                    layoutCtx.vBasis = __classPrivateFieldGet(this, _effectiveMainBasis);
            }
            else {
                layoutCtx.vBasis += __classPrivateFieldGet(this, _effectiveCrossBasis);
                if (__classPrivateFieldGet(this, _effectiveMainBasis) > layoutCtx.hBasis)
                    layoutCtx.hBasis = __classPrivateFieldGet(this, _effectiveMainBasis);
            }
        }
    }
    handleResolveLayout(layoutCtx) {
        ...
        if (layoutCtx.vertical !== vertical) {
            if (__classPrivateFieldGet(this, _flexRatio) > 0) {
                ...
                length = __classPrivateFieldGet(this, _effectiveMainBasis);
        }
        else {
            if (__classPrivateFieldGet(this, _flexRatio) > 0) {
                if (vertical)
                    length = (layoutCtx.maxHeight - layoutCtx.vBasis) * __classPrivateFieldGet(this, _flexRatio) / layoutCtx.vFlex;
                else
                    length = (layoutCtx.maxWidth - layoutCtx.hBasis) * __classPrivateFieldGet(this, _flexRatio) / layoutCtx.hFlex;
                length = __classPrivateFieldGet(this, _effectiveMainBasis) + Math.max(0, length);
            }
            else
                length = __classPrivateFieldGet(this, _effectiveMainBasis);
        }
        if (vertical) {
            this.resolvedWidth = __classPrivateFieldGet(this, _effectiveCrossBasis);
            this.resolvedHeight = length;
        }
        else {
            this.resolvedWidth = length;
            this.resolvedHeight = __classPrivateFieldGet(this, _effectiveCrossBasis);
        }
    }
}
_flexRatio = new WeakMap(), _mainBasis = new WeakMap(), _crossBasis = new WeakMap(), _internalMainBasis = new WeakMap(), _internalCrossBasis = new WeakMap(), _effectiveMainBasis = new WeakMap(), _effectiveCrossBasis = new WeakMap(), _vertical$1 = new WeakMap();
...
class Label extends Labelable(FlexWidget) {
    ...
    set text(text) {
        if (text instanceof Function)
            __classPrivateFieldSet(this, _textGetter, text);
        else
            this.setText(text);
    }
    get text() {
        if (__classPrivateFieldGet(this, _textGetter) !== null)
            return __classPrivateFieldGet(this, _textGetter);
        else
            return this._text;
    }
    get currentText() {
    ...
    handlePreLayoutUpdate(_root) {
        ...
        if (__classPrivateFieldGet(this, _textGetter) !== null)
            this.setText(__classPrivateFieldGet(this, _textGetter).call(this));
        this.setFont(this.theme.getFont(exports.ThemeProperty.BodyTextFont));
        this.setMinLabelWidth(this.theme.getSize(exports.ThemeProperty.LabelMinWidth));
        this.setMinLabelAscent(this.theme.getSize(exports.ThemeProperty.LabelMinAscent));
        this.setMinLabelDescent(this.theme.getSize(exports.ThemeProperty.LabelMinDescent));
        this.internalMainBasis = this.labelWidth;
        this.internalCrossBasis = this.labelHeight;
    }
    handlePainting(x, y, _width, height, ctx) {
        ctx.font = this._font;
        ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.BodyTextFill);
        ctx.fillText(this._text, x, y + height - this.labelDescent);
    }
}
_textGetter = new WeakMap();
...
var _backgroundDirty, _vertical, _innerContext;
// FIXME protected and private members were turned public due to a declaration
// emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
class MultiContainer extends MultiParentWidget {
    ...
    constructor(vertical, themeOverride = null) {
        ...
        _backgroundDirty.set(this, true);
        // Is this container vertical?
        _vertical.set(this, void 0);
        // Temporary layout context for layout resolution
        _innerContext.set(this, null);
        __classPrivateFieldSet(this, _vertical, vertical);
    }
    handleEvent(event, width, height, root) {
        // Find which widget the event should go to
        const spacing = this.theme.getSize(exports.ThemeProperty.ContainerSpacing);
        for (const child of this.children) {
            // Ignore disabled children
            if (!child.enabled)
                continue;
            const length = __classPrivateFieldGet(this, _vertical) ? child.resolvedHeight : child.resolvedWidth;
            // Dispatch to this widget
            let childWidth, childHeight;
            if (__classPrivateFieldGet(this, _vertical)) {
                childWidth = width;
                childHeight = length;
            }
            else {
    ...
    forceLayoutDirty() {
        __classPrivateFieldSet(this, _backgroundDirty, true);
        super.forceLayoutDirty();
    }
    handlePopulateLayout(layoutCtx) {
        // Setup context. Use inner context if verticality is different
        const usingInlineContext = (__classPrivateFieldGet(this, _vertical) === layoutCtx.vertical);
        let usedContext;
        if (usingInlineContext)
            usedContext = layoutCtx;
        else {
            __classPrivateFieldSet(this, _innerContext, new LayoutContext(layoutCtx.maxWidth, layoutCtx.maxHeight, __classPrivateFieldGet(this, _vertical)));
            usedContext = __classPrivateFieldGet(this, _innerContext);
        }
    ...
    handleResolveLayout(layoutCtx) {
        ...
        if (!usingInlineContext && usedContext.sizeChanged)
            layoutCtx.sizeChanged = true;
        // Clear inner context
        __classPrivateFieldSet(this, _innerContext, null);
    ...
    handlePainting(x, y, width, height, ctx) {
        ...
        const spacing = this.theme.getSize(exports.ThemeProperty.ContainerSpacing);
        if (__classPrivateFieldGet(this, _backgroundDirty) && spacing > 0)
            this.clear(x, y, width, height, ctx);
        __classPrivateFieldSet(this, _backgroundDirty, false);
        // Calculate helper variables
        const mainAxisMax = __classPrivateFieldGet(this, _vertical) ? (y + height) : (x + width);
        // Paint children
        for (const child of this.children) {
            // Ignore disabled children
            if (!child.enabled)
...
_backgroundDirty = new WeakMap(), _vertical = new WeakMap(), _innerContext = new WeakMap();
...
function Center(child) {
    const themeOverride = new Theme(new Map([
        [
            exports.ThemeProperty.ContainerAlignment,
            {
                horizontal: exports.Alignment.Center, vertical: exports.Alignment.Center,
            },
        ],
        [
            exports.ThemeProperty.ContainerPadding,
...
class BoxWidget extends Widget {
    constructor() {
        ...
        _boxWidth.set(this, 0);
        _boxHeight.set(this, 0);
    }
    get boxWidth() {
        return __classPrivateFieldGet(this, _boxWidth);
    }
    set boxWidth(boxWidth) {
        if (__classPrivateFieldGet(this, _boxWidth) !== boxWidth) {
            __classPrivateFieldSet(this, _boxWidth, boxWidth);
            this.layoutDirty = true;
        }
    }
    get boxHeight() {
        return __classPrivateFieldGet(this, _boxHeight);
    }
    set boxHeight(boxHeight) {
        if (__classPrivateFieldGet(this, _boxHeight) !== boxHeight) {
            __classPrivateFieldSet(this, _boxHeight, boxHeight);
            this.layoutDirty = true;
        }
    }
    handlePopulateLayout(layoutCtx) {
        layoutCtx.addBasis(__classPrivateFieldGet(this, _boxWidth), __classPrivateFieldGet(this, _boxHeight));
    }
    handleResolveLayout(_layoutCtx) {
        this.resolvedWidth = __classPrivateFieldGet(this, _boxWidth);
        this.resolvedHeight = __classPrivateFieldGet(this, _boxHeight);
    }
}
_boxWidth = new WeakMap(), _boxHeight = new WeakMap();
...
class Checkbox extends Clickable(Variable(BoxWidget, false)) {
    ...
    getBoxRect(x, y, width, height) {
        // Find actual length
        const length = this.theme.getSize(exports.ThemeProperty.CheckboxLength);
    ...
    handlePainting(x, y, width, height, ctx) {
        ...
        const useGlow = [exports.ClickState.Hover, exports.ClickState.Hold].includes(this.clickState);
        // Draw unchecked part of checkbox
        if (useGlow)
            ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.BackgroundGlowFill);
        else
            ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.BackgroundFill);
        ctx.fillRect(bx, by, actualLength, actualLength);
        // Draw checked part of checkbox
        if (this.value) {
            if (useGlow)
                ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.AccentFill);
            else
                ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.PrimaryFill);
            const innerPadding = this.theme.getSize(exports.ThemeProperty.CheckboxInnerPadding);
...
var _blinkStart, _blinkWasOn, _cursorPos, _cursorOffset, _cursorOffsetDirty, _editingEnabled, _hideText, _valid, _validValue;
// FIXME protected members were turned public due to a declaration emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
class TextInput extends Labelable(Variable(FlexWidget, '')) {
    ...
    constructor(validator, initialValue = '', themeOverride = null) {
        ...
        _blinkStart.set(this, 0);
        // Was the cursor shown last frame due to blinking?
        _blinkWasOn.set(this, null);
        // Current cursor position (index)
        _cursorPos.set(this, 0);
        // Current cursor offset (pixels)
        _cursorOffset.set(this, 0);
        // Does the cursor offset need to be updated?
        _cursorOffsetDirty.set(this, false);
        // Is editing enabled?
        _editingEnabled.set(this, true);
        // Is the text hidden?
        _hideText.set(this, false);
        // Is the text valid?
        _valid.set(this, void 0);
        // Last valid value
        _validValue.set(this, void 0);
        this.setValue(initialValue, false);
        _a = this, _b = this, [({ set value(_c) { __classPrivateFieldSet(_a, _valid, _c); } }).value, ({ set value(_c) { __classPrivateFieldSet(_b, _validValue, _c); } }).value] = validator(initialValue);
        this.callback = (text) => {
            const [valid, validatedValue] = validator(text);
            if (valid)
                __classPrivateFieldSet(this, _validValue, validatedValue);
            if (valid !== __classPrivateFieldGet(this, _valid)) {
    ...
    get blinkOn() {
        if (__classPrivateFieldGet(this, _blinkStart) === 0)
            return null;
        const blinkRate = this.theme.getSize(exports.ThemeProperty.BlinkRate);
        return Math.trunc(((Date.now() - __classPrivateFieldGet(this, _blinkStart)) / (500 * blinkRate)) % 2) === 0;
    }
    get editingEnabled() {
        return __classPrivateFieldGet(this, _editingEnabled);
    }
    set editingEnabled(editingEnabled) {
        if (__classPrivateFieldGet(this, _editingEnabled) !== editingEnabled) {
            __classPrivateFieldSet(this, _editingEnabled, editingEnabled);
            // Disable blinking and reset cursor position if disabled
            if (!editingEnabled) {
                __classPrivateFieldSet(this, _blinkStart, 0);
                this.moveCursorTo(0);
            }
    ...
    get hideText() {
        return __classPrivateFieldGet(this, _hideText);
    }
    set hideText(hideText) {
        if (__classPrivateFieldGet(this, _hideText) !== hideText) {
            __classPrivateFieldSet(this, _hideText, hideText);
            // Mark as dirty and cursor offset as dirty; the text is
            // (de)obfuscated
            __classPrivateFieldSet(this, _cursorOffsetDirty, true);
            this.dirty = true;
        }
    }
    get text() {
        if (__classPrivateFieldGet(this, _hideText))
    ...
    get validValue() {
        return __classPrivateFieldGet(this, _validValue);
    }
    moveCursorTo(index) {
        // Update cursor position, checking for boundaries
        __classPrivateFieldSet(this, _cursorPos, Math.min(Math.max(index, 0), this.value.length));
        // Update cursor offset
        __classPrivateFieldSet(this, _cursorOffsetDirty, true);
        this.dirty = true;
    }
    moveCursor(delta) {
        this.moveCursorTo(__classPrivateFieldGet(this, _cursorPos) + delta);
    }
    insertText(str) {
        // Insert string in current cursor position
        this.value = this.value.substring(0, __classPrivateFieldGet(this, _cursorPos)) + str + this.value.substring(__classPrivateFieldGet(this, _cursorPos));
    ...
    deleteText(delta) {
        ...
        // cursor
        if (delta > 0)
            this.value = this.value.substring(0, __classPrivateFieldGet(this, _cursorPos)) + this.value.substring(__classPrivateFieldGet(this, _cursorPos) + delta);
        else if (delta < 0) {
            // NOTE, still checking if delta < 0 so that nothing is done if
            // delta is 0
            this.value = this.value.substring(0, __classPrivateFieldGet(this, _cursorPos) + delta) + this.value.substring(__classPrivateFieldGet(this, _cursorPos));
            this.moveCursor(delta);
        }
    }
    onFocusDropped(focusType, _root) {
        // Stop blinking cursor if keyboard focus lost
        if (focusType === exports.FocusType.Keyboard)
            __classPrivateFieldSet(this, _blinkStart, 0);
    }
    handleEvent(event, _width, _height, root) {
        var _a, _b;
        // If editing is disabled, abort
        if (!__classPrivateFieldGet(this, _editingEnabled))
            return this;
        if (event instanceof PointerEvent) {
            ...
            if (event instanceof PointerPress) {
                ...
                _a = this, _b = this, [({ set value(_c) { __classPrivateFieldSet(_a, _cursorPos, _c); } }).value, ({ set value(_c) { __classPrivateFieldSet(_b, _cursorOffset, _c); } }).value] = this.findIndexOffsetFromOffset(event.x);
                // Start blinking cursor and mark component as dirty, to
                // make sure that cursor blink always resets for better
                // feedback
                __classPrivateFieldSet(this, _blinkStart, Date.now());
                this.dirty = true;
                // Request focus
                root.requestFocus(exports.FocusType.Keyboard, this);
            }
            ...
            if (event.key.length === 1)
                ...
                root.dropFocus(exports.FocusType.Keyboard, this); // Drop focus
                return this;
            }
            else
                return this; // Ignore key if it is unknown
            // Reset blink time for better feedback
            __classPrivateFieldSet(// Ignore key if it is unknown
    ...
    handlePreLayoutUpdate(root) {
        ...
        if (!this.editingEnabled)
            root.dropFocus(exports.FocusType.Keyboard, this);
        // Mark as dirty when a blink needs to occur
        if (this.blinkOn !== __classPrivateFieldGet(this, _blinkWasOn))
            this.dirty = true;
        // Update Labelable variables
        const cursorPadding = this.theme.getSize(exports.ThemeProperty.CursorPadding);
        const cursorThickness = this.theme.getSize(exports.ThemeProperty.CursorThickness);
        const widthError = cursorPadding + cursorThickness;
        this.setText(this.text);
        this.setFont(this.theme.getFont(exports.ThemeProperty.InputTextFont));
        this.setMinLabelWidth(this.theme.getSize(exports.ThemeProperty.InputTextMinWidth) - widthError);
        this.setMinLabelAscent(this.theme.getSize(exports.ThemeProperty.InputTextMinAscent));
        this.setMinLabelDescent(this.theme.getSize(exports.ThemeProperty.InputTextMinDescent));
        if (__classPrivateFieldGet(this, _cursorOffsetDirty)) {
            __classPrivateFieldSet(this, _cursorOffset, this.findOffsetFromIndex(__classPrivateFieldGet(this, _cursorPos)));
            __classPrivateFieldSet(this, _cursorOffsetDirty, false);
        }
        this.flexRatio = this.theme.getSize(exports.ThemeProperty.InputTextFlexRatio);
        this.internalMainBasis = this.labelWidth + widthError;
        this.internalCrossBasis = this.labelHeight;
    }
    handlePainting(x, y, width, height, ctx) {
        // Paint background
        ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.InputBackgroundFill);
        ctx.fillRect(x, y, width, height);
        // Paint current text value
        ctx.font = this.theme.getFont(exports.ThemeProperty.InputTextFont);
        if (__classPrivateFieldGet(this, _editingEnabled)) {
            if (__classPrivateFieldGet(this, _valid))
                ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.InputTextFill);
            else
                ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.InputTextFillInvalid);
        }
        else
            ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.InputTextFillDisabled);
        ctx.fillText(this.text, x, y + height - this.labelDescent);
        // Paint blink
        const blinkOn = this.blinkOn;
        __classPrivateFieldSet(this, _blinkWasOn, blinkOn);
        if (!blinkOn)
            return;
        const cursorPadding = this.theme.getSize(exports.ThemeProperty.CursorPadding);
        const cursorThickness = this.theme.getSize(exports.ThemeProperty.CursorThickness);
        ctx.fillRect(x + __classPrivateFieldGet(this, _cursorOffset), y + cursorPadding, cursorThickness, height - cursorPadding * 2);
    }
}
_blinkStart = new WeakMap(), _blinkWasOn = new WeakMap(), _cursorPos = new WeakMap(), _cursorOffset = new WeakMap(), _cursorOffsetDirty = new WeakMap(), _editingEnabled = new WeakMap(), _hideText = new WeakMap(), _valid = new WeakMap(), _validValue = new WeakMap();
...
function MakeCompositeValidator(validators, defaultValue) {
    return (value) => {
        let valid = true;
        let nextValue = value;
...
class Icon extends Clickable(BoxWidget) {
    ...
    updateDimensions() {
        ...
        if (wantedWidth === null) {
            if (this.viewBox === null)
                wantedWidth = __classPrivateFieldGet(this, _image).width;
            else
        ...
        if (wantedHeight === null) {
            if (this.viewBox === null)
                wantedHeight = __classPrivateFieldGet(this, _image).height;
            else
    ...
    setImage(image) {
        if (image !== __classPrivateFieldGet(this, _image)) {
            __classPrivateFieldSet(this, _image, image);
            __classPrivateFieldSet(this, _lastSrc, null);
        }
    }
    ...
    handlePreLayoutUpdate(_root) {
        ...
        // loaded yet
        if (((_a = __classPrivateFieldGet(this, _image)) === null || _a === void 0 ? void 0 : _a.src) !== __classPrivateFieldGet(this, _lastSrc) && ((_b = __classPrivateFieldGet(this, _image)) === null || _b === void 0 ? void 0 : _b.complete))
            this.dirty = true;
    ...
    set rotation(rotation) {
        if (rotation !== __classPrivateFieldGet(this, _rotation)) {
            __classPrivateFieldSet(this, _rotation, rotation);
            this.dirty = true;
        }
    }
    handlePainting(x, y, width, height, ctx) {
        ...
        if (!((_a = __classPrivateFieldGet(this, _image)) === null || _a === void 0 ? void 0 : _a.complete)) {
            __classPrivateFieldSet(this, _lastSrc, null);
            return;
        }
        // Mark as not needing to be drawn by setting the source
        __classPrivateFieldSet(this, _lastSrc, __classPrivateFieldGet(this, _image).src);
        ...
        if (this.viewBox === null)
            ctx.drawImage(__classPrivateFieldGet(this, _image), tdx, tdy, dw, dh);
        else
            ctx.drawImage(__classPrivateFieldGet(this, _image), ...this.viewBox, tdx, tdy, dw, dh);
        // Revert transformation
        if (this.rotation !== 0)
            ctx.restore();
    }
}
_image = new WeakMap(), _lastSrc = new WeakMap(), _rotation = new WeakMap();
...
var _viewport$1, _offset, _lastChildLayoutCtx;
// FIXME protected and private members were turned public due to a declaration
// emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
class ViewportWidget extends Parent(FlexWidget) {
    ...
    constructor(child, mainBasisTied = false, crossBasisTied = false, themeOverride = null) {
        ...
        __classPrivateFieldSet(this, _viewport$1, new Viewport());
        this.mainBasisTied = mainBasisTied;
        this.crossBasisTied = crossBasisTied;
        this.children.push(child);
    }
    get canvasDimensions() {
        return __classPrivateFieldGet(this, _viewport$1).canvasDimensions;
    }
    get offset() {
        return [...__classPrivateFieldGet(this, _offset)];
    }
    set offset(offset) {
        if (__classPrivateFieldGet(this, _offset)[0] !== offset[0] || __classPrivateFieldGet(this, _offset)[1] !== offset[1]) {
    ...
    getChildMainBasis(vertical) {
        if (__classPrivateFieldGet(this, _lastChildLayoutCtx) === null)
            return 0;
        const innerLength = vertical ? __classPrivateFieldGet(this, _lastChildLayoutCtx).vBasis
            : __classPrivateFieldGet(this, _lastChildLayoutCtx).hBasis;
    ...
    handlePreLayoutUpdate(root) {
        ...
        const child = this.getChild();
        if (currentVerticality !== __classPrivateFieldGet(this, _viewport$1).vertical) {
            __classPrivateFieldGet(this, _viewport$1).vertical = currentVerticality;
        ...
        __classPrivateFieldSet(this, _lastChildLayoutCtx, __classPrivateFieldGet(this, _viewport$1).populateChildsLayout(child));
    ...
    handlePostLayoutUpdate(root) {
        ...
        if (__classPrivateFieldGet(this, _lastChildLayoutCtx) !== null) {
            ...
            if (__classPrivateFieldGet(this, _viewport$1).vertical ? this.crossBasisTied : this.mainBasisTied) {
                if (newMaxWidth === 0 || this.resolvedWidth < newMaxWidth)
                    newMaxWidth = this.resolvedWidth;
            }
            if (__classPrivateFieldGet(this, _viewport$1).vertical ? this.mainBasisTied : this.crossBasisTied) {
                if (newMaxHeight === 0 || this.resolvedHeight < newMaxHeight)
                    newMaxHeight = this.resolvedHeight;
            }
            __classPrivateFieldGet(this, _viewport$1).maxDimensions = [newMaxWidth, newMaxHeight];
            __classPrivateFieldGet(this, _lastChildLayoutCtx).maxWidth = newMaxWidth;
            __classPrivateFieldGet(this, _lastChildLayoutCtx).maxHeight = newMaxHeight;
            // Resolve child's layout
            __classPrivateFieldGet(this, _viewport$1).resolveChildsLayout(child, __classPrivateFieldGet(this, _lastChildLayoutCtx));
            // Clear layout context, no longer needed
            __classPrivateFieldSet(this, _lastChildLayoutCtx, null);
        }
        // Post-layout update child
        child.postLayoutUpdate(root);
        // If child is dirty, set self as dirty
    ...
    handlePainting(x, y, width, height, ctx) {
        ...
        __classPrivateFieldGet(this, _viewport$1).paintToCanvas(this.getChild());
        // Save context
        ctx.save();
        ...
        ctx.clip(offsetClip);
        ctx.drawImage(__classPrivateFieldGet(this, _viewport$1).canvas, 0, 0, innerWidth, innerHeight, xDst, yDst, innerWidth, innerHeight);
        // Restore context
        ctx.restore();
    }
    getChild() {
...
_viewport$1 = new WeakMap(), _offset = new WeakMap(), _lastChildLayoutCtx = new WeakMap();

var _end, _barLength, _dragValue;
// FIXME protected and private members were turned public due to a declaration
// emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
...
class ScrollBar extends Clickable(Variable(FlexWidget, 0)) {
    constructor(callback = null, end = 100, barLength = 100, initialValue = 0, themeOverride = null) {
        ...
        _barLength.set(this, void 0);
        // What was the value when dragging began?
        _dragValue.set(this, void 0);
        this.callback = callback;
        this.setValue(initialValue, false);
        __classPrivateFieldSet(this, _end, end);
        __classPrivateFieldSet(this, _barLength, barLength);
        __classPrivateFieldSet(this, _dragValue, initialValue);
    }
    get end() {
        return __classPrivateFieldGet(this, _end);
    }
    set end(end) {
        if (__classPrivateFieldGet(this, _end) !== end) {
            __classPrivateFieldSet(this, _end, end);
            this.dirty = true;
        }
    }
    get barLength() {
        return __classPrivateFieldGet(this, _barLength);
    }
    set barLength(barLength) {
        if (__classPrivateFieldGet(this, _barLength) !== barLength) {
            __classPrivateFieldSet(this, _barLength, barLength);
            this.dirty = true;
        }
    }
    setValue(value, doCallback = true) {
        super.setValue(Math.max(Math.min(__classPrivateFieldGet(this, _end) - __classPrivateFieldGet(this, _barLength), value), 0), doCallback);
    }
    ...
    handleEvent(event, width, height, root) {
        ...
        if (this.clickState == exports.ClickState.Hold && this.pointerPos !== null) {
            // Interpolate and update value, taking drag into account
            if (this.clickStateChanged) {
                // If not inside filled part of bar, snap value
                let clickVal;
                if (this.lastVertical)
                    clickVal = this.pointerPos[1] * __classPrivateFieldGet(this, _end);
                else
                    clickVal = this.pointerPos[0] * __classPrivateFieldGet(this, _end);
                let value = this.value;
                if (value === null)
                    value = 0;
                if (clickVal < value || clickVal >= (value + __classPrivateFieldGet(this, _barLength))) {
                    value = clickVal - __classPrivateFieldGet(this, _barLength) / 2;
                    this.value = value;
                }
                __classPrivateFieldSet(this, _dragValue, value);
            }
            else {
                if (this.startingPointerPos !== null) {
                    ...
                    this.value = __classPrivateFieldGet(this, _dragValue) + dragChange * __classPrivateFieldGet(this, _end);
                }
            }
        }
    ...
    handlePreLayoutUpdate(_root) {
        ...
        this.flexRatio = 0;
        this.crossBasis = this.theme.getSize(exports.ThemeProperty.ScrollBarThickness);
    }
    handlePainting(x, y, width, height, ctx) {
        ...
        if (value === null)
            value = 0;
        const start = value / __classPrivateFieldGet(this, _end);
        const percent = __classPrivateFieldGet(this, _barLength) / __classPrivateFieldGet(this, _end);
        // Draw empty part of bar
        ctx.fillStyle = this.theme.getFill(exports.ThemeProperty.BackgroundFill);
        ctx.fillRect(sl, st, sw, sh);
        // Draw filled part of bar
        // Use accent colour if hovering or holding
        const accentStates = [exports.ClickState.Hover, exports.ClickState.Hold];
...
_end = new WeakMap(), _barLength = new WeakMap(), _dragValue = new WeakMap();

var _viewport, _vScroll, _hScroll;
// FIXME protected and private members were turned public due to a declaration
// emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
class ScrollableViewportWidget extends PassthroughWidget {
    constructor(child, vertical, mainBasisTied = false, crossBasisTied = false, themeOverride = null) {
        ...
        _vScroll.set(this, void 0);
        _hScroll.set(this, void 0);
        // Create grid
        ...
        __classPrivateFieldSet(this, _viewport, viewport);
        __classPrivateFieldSet(this, _vScroll, vScroll);
        __classPrivateFieldSet(this, _hScroll, hScroll);
        this.vScrollHide = false;
        this.hScrollHide = false;
        hScroll.callback = (newScroll) => {
            if (newScroll === null)
                newScroll = 0;
            __classPrivateFieldGet(this, _viewport).offset = [-newScroll, __classPrivateFieldGet(this, _viewport).offset[1]];
        };
        vScroll.callback = (newScroll) => {
            if (newScroll === null)
                newScroll = 0;
            __classPrivateFieldGet(this, _viewport).offset = [__classPrivateFieldGet(this, _viewport).offset[0], -newScroll];
        };
    }
    get maxDimensions() {
        return __classPrivateFieldGet(this, _viewport).maxDimensions;
    }
    set maxDimensions(maxDimensions) {
        __classPrivateFieldGet(this, _viewport).maxDimensions = maxDimensions;
    }
    get flexRatio() {
        return __classPrivateFieldGet(this, _viewport).flexRatio;
    }
    set flexRatio(flexRatio) {
        __classPrivateFieldGet(this, _viewport).flexRatio = flexRatio;
    }
    get mainBasis() {
        return __classPrivateFieldGet(this, _viewport).mainBasis;
    }
    set mainBasis(mainBasis) {
        __classPrivateFieldGet(this, _viewport).mainBasis = mainBasis;
    }
    get crossBasis() {
        return __classPrivateFieldGet(this, _viewport).crossBasis;
    }
    set crossBasis(crossBasis) {
        __classPrivateFieldGet(this, _viewport).crossBasis = crossBasis;
    }
    get containedChild() {
        return __classPrivateFieldGet(this, _viewport).getChild();
    }
    resetScroll() {
        __classPrivateFieldGet(this, _hScroll).value = 0;
        __classPrivateFieldGet(this, _vScroll).value = 0;
    }
    handlePreLayoutUpdate(root) {
        const [innerW, innerH] = __classPrivateFieldGet(this, _viewport).dimensions;
        if (__classPrivateFieldGet(this, _viewport).resolvedWidth < innerW && !this.hScrollHide)
            __classPrivateFieldGet(this, _hScroll).enable();
        else {
            __classPrivateFieldGet(this, _hScroll).value = 0;
            __classPrivateFieldGet(this, _hScroll).disable();
        }
        if (__classPrivateFieldGet(this, _viewport).resolvedHeight < innerH && !this.vScrollHide)
            __classPrivateFieldGet(this, _vScroll).enable();
        else {
            __classPrivateFieldGet(this, _vScroll).value = 0;
            __classPrivateFieldGet(this, _vScroll).disable();
        }
        super.handlePreLayoutUpdate(root);
    }
    handlePostLayoutUpdate(root) {
        [__classPrivateFieldGet(this, _hScroll).end, __classPrivateFieldGet(this, _vScroll).end] = __classPrivateFieldGet(this, _viewport).dimensions;
        __classPrivateFieldGet(this, _hScroll).barLength = __classPrivateFieldGet(this, _viewport).lastViewportDims[0];
        __classPrivateFieldGet(this, _vScroll).barLength = __classPrivateFieldGet(this, _viewport).lastViewportDims[1];
        super.handlePostLayoutUpdate(root);
    }
}
_viewport = new WeakMap(), _vScroll = new WeakMap(), _hScroll = new WeakMap();

var _minValue, _maxValue, _snapIncrement;
// FIXME protected and private members were turned public due to a declaration
// emission bug:
// https://github.com/Microsoft/TypeScript/issues/17744
class Slider extends Clickable(Variable(FlexWidget, 0)) {
    constructor(callback = null, minValue = 0, maxValue = 1, snapIncrement = 0, initialValue = 0, themeOverride = null) {
        ...
        _minValue.set(this, void 0);
        _maxValue.set(this, void 0);
        // The increments in which the slider changes value. If 0, there are no
        // fixed increments
        _snapIncrement.set(this, void 0);
        this.callback = callback;
        this.setValue(initialValue, false);
        __classPrivateFieldSet(this, _minValue, minValue);
        __classPrivateFieldSet(this, _maxValue, maxValue);
        __classPrivateFieldSet(this, _snapIncrement, snapIncrement);
    ...
    handleEvent(event, width, height, root) {
        ...
        // value
        if (((this.clickStateChanged && this.wasClick) || this.clickState == exports.ClickState.Hold)
            && this.pointerPos !== null) {
            // Interpolate value
            const percent = this.pointerPos[0];
            let newValue = __classPrivateFieldGet(this, _minValue) + percent * (__classPrivateFieldGet(this, _maxValue) - __classPrivateFieldGet(this, _minValue));
            // Snap to increments if needed
            if (__classPrivateFieldGet(this, _snapIncrement) > 0)
                newValue = Math.round(newValue / __classPrivateFieldGet(this, _snapIncrement)) * __classPrivateFieldGet(this, _snapIncrement);
            // Clamp value
            if (newValue < __classPrivateFieldGet(this, _minValue))
                newValue = __classPrivateFieldGet(this, _minValue);
            else if (newValue > __classPrivateFieldGet(this, _maxValue))
                newValue = __classPrivateFieldGet(this, _maxValue);
            // Update value
            this.value = newValue;
        }
        // Always flag as dirty if the click state changed (so glow colour takes
    ...
    handlePreLayoutUpdate(_root) {
        ...
        this.flexRatio = this.theme.getSize(exports.ThemeProperty.SliderFlexRatio);
        this.mainBasis = this.theme.getSize(exports.ThemeProperty.SliderMainBasis);
        this.crossBasis = this.theme.getSize(exports.ThemeProperty.SliderCrossBasis);
    }
    handlePainting(x, y, width, height, ctx) {
        ...
        if (value === null)
            value = 0;
        const percent = (value - __classPrivateFieldGet(this, _minValue)) / (__classPrivateFieldGet(this, _maxValue) - __classPrivateFieldGet(this, _minValue));
...
_minValue = new WeakMap(), _maxValue = new WeakMap(), _snapIncrement = new WeakMap();
...
class ThemeScope extends PassthroughWidget {
    ...
    constructor(child, themeOverride) {
        super(child, null);
        _scopeTheme.set(this, void 0);
        __classPrivateFieldSet(this, _scopeTheme, themeOverride);
    }
    // Set the scope theme
    setThemeOverride(scopeTheme) {
        __classPrivateFieldSet(this, _scopeTheme, scopeTheme);
        super.inheritTheme(__classPrivateFieldGet(this, _scopeTheme));
    }
    inheritTheme(_theme) {
...
_scopeTheme = new WeakMap();

exports.BackspaceKey = BackspaceKey;
exports.BaseContainer = BaseContainer;
exports.BasicKey = BasicKey;
exports.BasicTextInput = BasicTextInput;
...
exports.DefaultTextInputHandler = DefaultTextInputHandler;
exports.DefaultTextValidator = DefaultTextValidator;
exports.EnterKey = EnterKey;
exports.EscapeKey = EscapeKey;
exports.Event = Event;
exports.FilledButton = FilledButton;
exports.FlexWidget = FlexWidget;
exports.FloatValidator = FloatValidator;
exports.GlyphKey = GlyphKey;
exports.Icon = Icon;
exports.IntValidator = IntValidator;
exports.KeyEvent = KeyEvent;
exports.KeyPress = KeyPress;
exports.KeyRelease = KeyRelease;
exports.KeyRow = KeyRow;
exports.KeyboardDriver = KeyboardDriver;
exports.Label = Label;
exports.Labelable = Labelable;
exports.LabelledCheckbox = LabelledCheckbox;
exports.LayoutContext = LayoutContext;
exports.Leave = Leave;
exports.MakeCompositeValidator = MakeCompositeValidator;
exports.MakeDefaultTextValidatorWithCallback = MakeDefaultTextValidatorWithCallback;
exports.MakeRangeValidator = MakeRangeValidator;
exports.Margin = Margin;
exports.MultiContainer = MultiContainer;
exports.MultiParentWidget = MultiParentWidget;
exports.Parent = Parent;
exports.ParentWidget = ParentWidget;
exports.PassthroughWidget = PassthroughWidget;
exports.PointerEvent = PointerEvent;
exports.PointerMove = PointerMove;
exports.PointerPress = PointerPress;
exports.PointerRelease = PointerRelease;
exports.Root = Root;
exports.Row = Row;
exports.ScrollBar = ScrollBar;
exports.ScrollableViewportWidget = ScrollableViewportWidget;
exports.ShiftKey = ShiftKey;
exports.SingleParentWidget = SingleParentWidget;
...
exports.ViewportWidget = ViewportWidget;
exports.VirtualKeyboard = VirtualKeyboard;
exports.Widget = Widget;
exports.debugTheme = debugTheme;
exports.defaultTheme = defaultTheme;
exports.measureTextDims = measureTextDims;
