...
class DOMVirtualKeyboardRoot extends DOMRoot {
    constructor(keyboardDriver, keyboardTemplate = null, theme = defaultTheme) {
        ...
        this.domElem.addEventListener('blur', (event) => {
            if (__classPrivateFieldGet(this, _DOMVirtualKeyboardRoot_keyboardDriver) instanceof DOMKeyboardDriver) {
                if (__classPrivateFieldGet(this, _DOMVirtualKeyboardRoot_keyboardDriver).shouldClearFocus(event.relatedTarget))
                    __classPrivateFieldGet(this, _DOMVirtualKeyboardRoot_keyboardDriver).clearFocus();
            }
            else
                __classPrivateFieldGet(this, _DOMVirtualKeyboardRoot_keyboardDriver).clearFocus();
        });
        ...
        this.domElem.addEventListener('keydown', (event) => {
            event.preventDefault();
            __classPrivateFieldGet(this, _DOMVirtualKeyboardRoot_keyboardDriver).keyDown(event.key);
        });
        this.domElem.addEventListener('keyup', (event) => {
            event.preventDefault();
            __classPrivateFieldGet(this, _DOMVirtualKeyboardRoot_keyboardDriver).keyUp(event.key);
        });
    }
    update() {
...
var _DOMPointerDriver_mousePointerID;
...
_DOMPointerDriver_mousePointerID = new WeakMap();
