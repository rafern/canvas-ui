...
class DOMRoot extends Root {
    constructor(child, pointerStyleHandler = null, theme = defaultTheme) {
...
class PointerDriver {
    ...
    onFocusCapturerChanged(root, focusType, oldCapturer, _newCapturer) {
        const state = this._states.get(root);
        if (typeof state === 'undefined')
            return;
        // Special case: when the pointer focus capturer changes, dispatch a
        // leave event to the last capturer
        if (focusType === exports.FocusType.Pointer && oldCapturer !== null)
...
class DOMPointerDriver extends PointerDriver {
    constructor() {
        ...
        _DOMPointerDriver_mousePointerID.set(this, void 0);
