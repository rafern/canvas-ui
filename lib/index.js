...
class Root {
    ...
    dispatchEvent(event) {
        ...
        if (event.focusType === null)
            return;
        const oldCapturer = (_a = this._fociCapturers.get(event.focusType)) !== null && _a !== void 0 ? _a : null;
        if (oldCapturer === captured)
            return;
        // Special case: when the pointer focus capturer changes, dispatch a
        // leave event to the last capturer
        if (event.focusType === exports.FocusType.Pointer && oldCapturer !== null)
...
var _DOMRoot_domCanvasContext;
class DOMRoot extends Root {
    constructor(child, theme = defaultTheme) {
        super(child, null, theme);
        _DOMRoot_domCanvasContext.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _DOMRoot_domCanvasContext, context);
    ...
    update() {
        ...
        if (this.paint()) {
            __classPrivateFieldGet(this, _DOMRoot_domCanvasContext).globalCompositeOperation = 'copy';
            __classPrivateFieldGet(this, _DOMRoot_domCanvasContext).drawImage(this.canvas, 0, 0);
        }
    }
}
_DOMRoot_domCanvasContext = new WeakMap();
...
class FilledButton extends Button {
    constructor() {
        ...
        _FilledButton_backgroundProperty.set(this, exports.ThemeProperty.BackgroundFill);
    ...
    updateBackground() {
        ...
        if (__classPrivateFieldGet(this, _FilledButton_forced))
            __classPrivateFieldSet(this, _FilledButton_backgroundProperty, exports.ThemeProperty.PrimaryFill);
        else {
            switch (this.clickState) {
                case exports.ClickState.Hold:
                    __classPrivateFieldSet(this, _FilledButton_backgroundProperty, exports.ThemeProperty.AccentFill);
                    break;
                case exports.ClickState.Hover:
                    __classPrivateFieldSet(this, _FilledButton_backgroundProperty, exports.ThemeProperty.BackgroundGlowFill);
                    break;
                default:
                    __classPrivateFieldSet(this, _FilledButton_backgroundProperty, exports.ThemeProperty.BackgroundFill);
                    break;
            }
        }
...
var _VirtualKeyboard_keyContext;
...
class VirtualKeyboard extends MultiContainer {
    constructor(keyboardDriver, keyboardTemplate = null, themeOverride = null) {
        super(true, themeOverride);
        _VirtualKeyboard_keyContext.set(this, void 0);
        // Make context
        __classPrivateFieldSet(this, _VirtualKeyboard_keyContext, {
            callback: (key) => {
        ...
        for (const rowTemplate of keyboardTemplate)
            this.add(KeyRow(rowTemplate, __classPrivateFieldGet(this, _VirtualKeyboard_keyContext), themeOverride));
    }
}
_VirtualKeyboard_keyContext = new WeakMap();

var _DOMVirtualKeyboardRoot_keyboardDriver;
class DOMVirtualKeyboardRoot extends DOMRoot {
    constructor(keyboardDriver, keyboardTemplate = null, theme = defaultTheme) {
        ...
        _DOMVirtualKeyboardRoot_keyboardDriver.set(this, void 0);
        __classPrivateFieldSet(this, _DOMVirtualKeyboardRoot_keyboardDriver, keyboardDriver);
    }
    update() {
        // Update visibility of root by enabling/disabling it
        this.enabled = __classPrivateFieldGet(this, _DOMVirtualKeyboardRoot_keyboardDriver).getFocusedRoot() !== null;
        // Update normally
        super.update();
    }
}
_DOMVirtualKeyboardRoot_keyboardDriver = new WeakMap();

var _VirtualKeyboardRoot_keyboardDriver;
class VirtualKeyboardRoot extends Root {
    constructor(keyboardDriver, keyboardTemplate = null, pointerStyleHandler = null, theme = defaultTheme) {
        ...
        _VirtualKeyboardRoot_keyboardDriver.set(this, void 0);
        __classPrivateFieldSet(this, _VirtualKeyboardRoot_keyboardDriver, keyboardDriver);
    }
    updateVisibility() {
        // Update visibility of root by enabling/disabling it
        this.enabled = __classPrivateFieldGet(this, _VirtualKeyboardRoot_keyboardDriver).getFocusedRoot() !== null;
    }
}
_VirtualKeyboardRoot_keyboardDriver = new WeakMap();
...
class KeyboardDriver {
    ...
    _changeFocusedRoot(root) {
        if (this.focus !== null)
            this.focus.clearFocus(exports.FocusType.Keyboard);
        this.focus = root;
        this.keysDown.clear();
    }
    getFocusedRoot() {
...
var _DOMKeyboardDriver_domElems;
class DOMKeyboardDriver extends KeyboardDriver {
    constructor() {
        super(...arguments);
        ...
        _DOMKeyboardDriver_domElems.set(this, new Set());
    }
    bindDOMElem(domElem, listenToKeys = true) {
        // Add to set. If it was already in set, abort
        if (__classPrivateFieldGet(this, _DOMKeyboardDriver_domElems).has(domElem))
            return;
        __classPrivateFieldGet(this, _DOMKeyboardDriver_domElems).add(domElem);
    ...
    shouldClearFocus(newTarget) {
        return newTarget === null || !__classPrivateFieldGet(this, _DOMKeyboardDriver_domElems).has(newTarget);
    }
}
_DOMKeyboardDriver_domElems = new WeakMap();
...
class PointerDriver {
    ...
    unregisterPointer(pointer) {
        for (const [root, state] of this._states) {
            ...
            if (state.pointer === pointer) {
                state.pointer = null;
                if (state.hovering) {
                    state.eventQueue.push(new Leave(root.getFocusCapturer(exports.FocusType.Pointer)));
                }
    ...
    movePointer(root, pointer, xNorm, yNorm, pressing = null) {
...
var _DOMPointerDriver_domElems, _DOMPointerDriver_mousePointerID;
function getEventPos(event, domElem) {
...
class DOMPointerDriver extends PointerDriver {
    constructor() {
        super();
        ...
        _DOMPointerDriver_domElems.set(this, new WeakMap());
        _DOMPointerDriver_mousePointerID.set(this, void 0); // TODO support multiple "mouse" pointers for multitouch
        __classPrivateFieldSet(this, _DOMPointerDriver_mousePointerID, this.registerPointer());
    }
    bindDOMElem(root, domElem) {
        let rootBind = __classPrivateFieldGet(this, _DOMPointerDriver_domElems).get(root);
        if (typeof rootBind !== 'undefined')
            ...
            __classPrivateFieldGet(this, _DOMPointerDriver_domElems).set(root, rootBind);
        }
        if (root.enabled)
    ...
    addListeners(root, rootBind) {
        ...
        rootBind.pointermoveListen = (event) => {
            if (event.isPrimary)
                this.movePointer(root, __classPrivateFieldGet(this, _DOMPointerDriver_mousePointerID), ...getEventPos(event, domElem));
        };
        rootBind.pointerdownListen = (event) => {
            if (event.isPrimary)
                this.movePointer(root, __classPrivateFieldGet(this, _DOMPointerDriver_mousePointerID), ...getEventPos(event, domElem), true);
        };
        rootBind.pointerupListen = (event) => {
            if (event.isPrimary)
                this.movePointer(root, __classPrivateFieldGet(this, _DOMPointerDriver_mousePointerID), ...getEventPos(event, domElem), false);
        };
        rootBind.pointerleaveListen = (event) => {
            if (event.isPrimary)
                this.leavePointer(root, __classPrivateFieldGet(this, _DOMPointerDriver_mousePointerID));
        };
...
_DOMPointerDriver_domElems = new WeakMap(), _DOMPointerDriver_mousePointerID = new WeakMap();
...
exports.DOMKeyboardDriver = DOMKeyboardDriver;
exports.DOMPointerDriver = DOMPointerDriver;
exports.DOMRoot = DOMRoot;
exports.DOMVirtualKeyboardRoot = DOMVirtualKeyboardRoot;
...
exports.PointerDriver = PointerDriver;
...
exports.VirtualKeyboardRoot = VirtualKeyboardRoot;
