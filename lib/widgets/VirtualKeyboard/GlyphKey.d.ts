...
export declare class GlyphKey extends TextButton {
     ...
     */
    constructor(glyph: string, altGlyph: string | null | undefined, keyContext: KeyContext, flexRatio?: number, mainBasis?: number, crossBasis?: number, themeOverride?: Theme | null);
}
