...
export declare class Slider extends Slider_base {
    ...
    constructor(callback?: VariableCallback<number | null> | null, minValue?: number, maxValue?: number, snapIncrement?: number, initialValue?: number, themeOverride?: Theme | null);
