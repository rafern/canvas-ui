...
declare const Slider_base: import("ts-mixer/dist/types/types").Class<any[], FlexLayout & Clickable & NumberVariable, typeof FlexLayout & typeof Clickable & typeof NumberVariable, false>;
export declare class Slider extends Slider_base {
    ...
    getSliderRect(x: number, y: number, width: number, height: number): [number, number, number, number];
